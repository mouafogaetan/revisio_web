...
// Qualités disponibles (même liste que pour CoursVideoScreen)
const QUALITIES = [
...
export const ExerciceVideoScreen: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const player = new window.YT.Player('youtube-player-exercice', {
      videoId: videoId,
      playerVars: {
        controls: 0,
        modestbranding: 1,
      ...
      {selectedVideo ? (
        <div className="flex-1 flex flex-col">
          <div ref={iframeRef} className="relative bg-black rounded-lg overflow-hidden" style={{ aspectRatio: '16/9' }}>
            ...
            <div id="youtube-player-exercice" className="w-full h-full" />
